...
test("updates only the README projects marker block with GitHub and npm data", async () => {
  ...
  assert.match(
    readme,
    /\| <img src="\.\/icon\/badge-npm\.svg" alt="npm" width="28"> \| <a href="https:\/\/github\.com\/AlucPro\/tool-manage" target="_blank">tool-manage<\/a> \| <a href="https:\/\/tool\.aluc\.pro" target="_blank">Website<\/a> \| 12 \| 12\.3k total \| `1\.2\.3` \| Manage local AI tool plugins and skills from the terminal\. \|/,
  );
  assert.match(
    readme,
    /\| <img src="\.\/icon\/badge-project\.svg" alt="project" width="28"> \| <a href="https:\/\/rollingsagas\.com" target="_blank">Rolling Sagas<\/a> \| <a href="https:\/\/rollingsagas\.com" target="_blank">Website<\/a> \| manual \| - \| live \| Demo non-npm project configured by hand\. \|/,
  );
  assert.match(
    readme,
    /\| <img src="\.\/icon\/badge-obsidian\.svg" alt="obsidian" width="28"> \| <a href="https:\/\/github\.com\/AlucPro\/obsidian-lexinote" target="_blank">LexiNote<\/a> \| - \| 7 \| 4\.6k total \| - \| Demo Obsidian plugin\. \|/,
  );
  assert.match(
    readme,
    /\| <img src="\.\/icon\/badge-logseq\.svg" alt="logseq" width="28"> \| <a href="https:\/\/github\.com\/AlucPro\/logseq-plugin-leetcode" target="_blank">Logseq LeetCode<\/a> \| - \| 9 \| 699 total \| - \| Demo Logseq plugin\. \|/,
  );
